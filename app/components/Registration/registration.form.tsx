        ...
        >
          <div className="sm:w-[417px] w-full h-[174px] flex flex-col gap-[24px]">
            <input
              ...
              className="w-full h-[75px] pt-[24px] pr-[36px] pb-[24px] pl-[36px] bg-[#EFEFEF] border rounded-[64px] manrope text-[20px] font-[500] leading-[27.32px] text-[#827A7A] focus:outline-none"
            ></input>
